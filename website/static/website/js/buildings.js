var buildings = JSON.parse(document.getElementById('buildings').textContent);
    ...
    $( document ).ready(function() {
        ...
        if(!profile){
            $('#profile-upload').html("<h2>No uploaded profile available. Please, <a href='{% url 'desktop' %}'>upload your profile</a> first if you want to use all calculator functionalities.</h2>")
        }
        else{
