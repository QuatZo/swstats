...
class MonsterViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        manual_parameters=[
            ...
            openapi.Parameter('hp', openapi.IN_QUERY, "Monster HP (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('attack', openapi.IN_QUERY, "Monster Attack (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('defense', openapi.IN_QUERY, "Monster Defense (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('speed', openapi.IN_QUERY, "Monster Speed (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('res', openapi.IN_QUERY, "Monster Resistance (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('acc', openapi.IN_QUERY, "Monster Accuracy (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('crit_rate', openapi.IN_QUERY, "Monster Critical rate (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('crit_dmg', openapi.IN_QUERY, "Monster Critical Damage (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('eff_hp', openapi.IN_QUERY, "Monster Effective HP (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('eff_hp_def_break', openapi.IN_QUERY, "Monster Effective HP with Def Break (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_INTEGER, openapi.TYPE_INTEGER]),
            openapi.Parameter('avg_eff', openapi.IN_QUERY, "Monster Average Efficiency (min,max)", type=openapi.TYPE_ARRAY, items=[openapi.TYPE_NUMBER, openapi.TYPE_NUMBER]),
